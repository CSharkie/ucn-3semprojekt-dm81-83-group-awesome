...
namespace AwesomeServer
{
    ...
    partial void OnReservationIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Reservation_MovieSeat", Storage="_Reservation", ThisKey="ReservationId", OtherKey="Id", IsForeignKey=true, DeleteRule="CASCADE")]
		public Reservation Reservation
		{
			get
			{
