...
namespace AwesomeClient.ServiceReference {
    ...
    public interface IService {
        ...
        string createReservation(string name, bool taken, int seatCounts, int movieId, int[] seatIds);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/createReservation", ReplyAction="http://tempuri.org/IService/createReservationResponse")]
        System.Threading.Tasks.Task<string> createReservationAsync(string name, bool taken, int seatCounts, int movieId, int[] seatIds);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/updateSeat", ReplyAction="http://tempuri.org/IService/updateSeatResponse")]
        System.Threading.Tasks.Task<string> updateSeatAsync(int seatId, int col, int row, int roomId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/getMovieSeatsForMovie", ReplyAction="http://tempuri.org/IService/getMovieSeatsForMovieResponse")]
        AwesomeServer.MovieSeat[] getMovieSeatsForMovie(int movieId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/getMovieSeatsForMovie", ReplyAction="http://tempuri.org/IService/getMovieSeatsForMovieResponse")]
        System.Threading.Tasks.Task<AwesomeServer.MovieSeat[]> getMovieSeatsForMovieAsync(int movieId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/lastReservation", ReplyAction="http://tempuri.org/IService/lastReservationResponse")]
        int lastReservation();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/lastReservation", ReplyAction="http://tempuri.org/IService/lastReservationResponse")]
        System.Threading.Tasks.Task<int> lastReservationAsync();
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<AwesomeClient.ServiceReference.IService>, AwesomeClient.ServiceReference.IService {
        ...
        public string createReservation(string name, bool taken, int seatCounts, int movieId, int[] seatIds) {
            return base.Channel.createReservation(name, taken, seatCounts, movieId, seatIds);
        }
        
        public System.Threading.Tasks.Task<string> createReservationAsync(string name, bool taken, int seatCounts, int movieId, int[] seatIds) {
            return base.Channel.createReservationAsync(name, taken, seatCounts, movieId, seatIds);
        }
        ...
        public string updateSeat(int seatId, int col, int row, int roomId) {
            return base.Channel.updateSeat(seatId, col, row, roomId);
        }
        
        public System.Threading.Tasks.Task<string> updateSeatAsync(int seatId, int col, int row, int roomId) {
            return base.Channel.updateSeatAsync(seatId, col, row, roomId);
        }
        ...
        public AwesomeServer.MovieSeat[] getMovieSeatsForMovie(int movieId) {
            return base.Channel.getMovieSeatsForMovie(movieId);
        }
        
        public System.Threading.Tasks.Task<AwesomeServer.MovieSeat[]> getMovieSeatsForMovieAsync(int movieId) {
            return base.Channel.getMovieSeatsForMovieAsync(movieId);
        }
        ...
        public int lastReservation() {
            return base.Channel.lastReservation();
        }
        
        public System.Threading.Tasks.Task<int> lastReservationAsync() {
            return base.Channel.lastReservationAsync();
        }
