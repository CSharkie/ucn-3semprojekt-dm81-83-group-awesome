...
namespace GroupAwesomeService
{
    ...
    partial void InsertRoomMovy(RoomMovy instance);
    partial void UpdateRoomMovy(RoomMovy instance);
    partial void DeleteRoomMovy(RoomMovy instance);
    ...
    partial void DeleteSeat(Seat instance);
		...
		public System.Data.Linq.Table<RoomMovy> RoomMovies
		{
			get
			{
				return this.GetTable<RoomMovy>();
			}
		}
	...
	public partial class Movy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<RoomMovy> _RoomMovies;
		
		private EntitySet<RoomMovy> _RoomMovies1;
		
		private EntitySet<RoomMovy> _RoomMovies2;
		
		private EntitySet<RoomMovy> _RoomMovies3;
		
		private EntitySet<RoomMovy> _RoomMovies4;
    ...
    partial void OnTitleChanged();
		...
		public Movy()
		{
			this._RoomMovies = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies), new Action<RoomMovy>(this.detach_RoomMovies));
			this._RoomMovies1 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies1), new Action<RoomMovy>(this.detach_RoomMovies1));
			this._RoomMovies2 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies2), new Action<RoomMovy>(this.detach_RoomMovies2));
			this._RoomMovies3 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies3), new Action<RoomMovy>(this.detach_RoomMovies3));
			this._RoomMovies4 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies4), new Action<RoomMovy>(this.detach_RoomMovies4));
			OnCreated();
		}
		...
		public EntitySet<RoomMovy> RoomMovies
		{
			get
			{
		...
		public EntitySet<RoomMovy> RoomMovies1
		{
			get
			{
		...
		public EntitySet<RoomMovy> RoomMovies2
		{
			get
			{
		...
		public EntitySet<RoomMovy> RoomMovies3
		{
			get
			{
		...
		public EntitySet<RoomMovy> RoomMovies4
		{
			get
			{
		...
		private void attach_RoomMovies(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy = this;
		}
		
		private void detach_RoomMovies(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy = null;
		}
		
		private void attach_RoomMovies1(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy1 = this;
		}
		
		private void detach_RoomMovies1(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy1 = null;
		}
		
		private void attach_RoomMovies2(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy2 = this;
		}
		
		private void detach_RoomMovies2(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy2 = null;
		}
		
		private void attach_RoomMovies3(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy3 = this;
		}
		
		private void detach_RoomMovies3(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy3 = null;
		}
		
		private void attach_RoomMovies4(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy4 = this;
		}
		
		private void detach_RoomMovies4(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Movy4 = null;
		}
	...
	public partial class Reservation : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<RoomMovy> _RoomMovy;
    ...
    partial void OnTakenChanged();
		...
		public Reservation()
		{
			...
			this._RoomMovy = default(EntityRef<RoomMovy>);
			OnCreated();
		}
		...
		public int RMId
		{
			...
			set
			{
				if ((this._RMId != value))
				{
					if (this._RoomMovy.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoomMovy_Reservation", Storage="_RoomMovy", ThisKey="RMId", OtherKey="Id", IsForeignKey=true)]
		public RoomMovy RoomMovy
		{
			get
			{
				return this._RoomMovy.Entity;
			}
			set
			{
				RoomMovy previousValue = this._RoomMovy.Entity;
				if (((previousValue != value) 
							|| (this._RoomMovy.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._RoomMovy.Entity = null;
						previousValue.Reservations.Remove(this);
					}
					this._RoomMovy.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("RoomMovy");
				}
			}
		}
	...
	public partial class RoomMovy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Movy> _Movy1;
		
		private EntityRef<Movy> _Movy2;
		
		private EntityRef<Movy> _Movy3;
		
		private EntityRef<Movy> _Movy4;
    ...
    partial void OnDateAndTimeChanged();
		...
		public RoomMovy()
		{
			...
			this._Movy1 = default(EntityRef<Movy>);
			this._Movy2 = default(EntityRef<Movy>);
			this._Movy3 = default(EntityRef<Movy>);
			this._Movy4 = default(EntityRef<Movy>);
			...
			set
			{
				if ((this._MovieId != value))
				{
					if (((((this._Movy.HasLoadedOrAssignedValue || this._Movy1.HasLoadedOrAssignedValue) 
								...
								|| this._Movy4.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		public Movy Movy1
		{
			...
			set
			{
				Movy previousValue = this._Movy1.Entity;
				if (((previousValue != value) 
		...
		public Movy Movy2
		{
			...
			set
			{
				Movy previousValue = this._Movy2.Entity;
				if (((previousValue != value) 
		...
		public Movy Movy3
		{
			...
			set
			{
				Movy previousValue = this._Movy3.Entity;
				if (((previousValue != value) 
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movy_RoomMovy4", Storage="_Movy4", ThisKey="MovieId", OtherKey="Id", IsForeignKey=true)]
		public Movy Movy4
		{
			get
			{
				return this._Movy4.Entity;
			}
			set
			{
				Movy previousValue = this._Movy4.Entity;
				if (((previousValue != value) 
							|| (this._Movy4.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Movy4.Entity = null;
						previousValue.RoomMovies4.Remove(this);
					}
					this._Movy4.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("Movy4");
				}
			}
		}
	...
	public partial class Room : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<RoomMovy> _RoomMovies5;
    ...
    partial void OnRowsChanged();
		...
		public Room()
		{
			...
			this._RoomMovies3 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies3), new Action<RoomMovy>(this.detach_RoomMovies3));
			this._RoomMovies4 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies4), new Action<RoomMovy>(this.detach_RoomMovies4));
			this._RoomMovies5 = new EntitySet<RoomMovy>(new Action<RoomMovy>(this.attach_RoomMovies5), new Action<RoomMovy>(this.detach_RoomMovies5));
		...
		public EntitySet<RoomMovy> RoomMovies5
		{
			get
			{
		...
		private void attach_RoomMovies5(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Room5 = this;
		}
		
		private void detach_RoomMovies5(RoomMovy entity)
		{
			this.SendPropertyChanging();
			entity.Room5 = null;
		}
